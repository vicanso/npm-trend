...
const SHA256 = (function() {
  function u(c, a, b) {
    ...
    k = b.numRounds || 1;
    q = z(a, e);
    if (k !== parseInt(k, 10) || 1 > k) throw Error(
    ...
    this.setHMACKey = function(a, b, d) {
      ...
      for (a = 0; a <= d; a += 1) l[a] = b[a] ^ 909522486, r[a] = b[a] ^
        1549556828;
      h = x(l, h);
      g = n;
      p = !0
    ...
    this.update = function(a) {
      ...
      c = b.value;
      b = a >>> 5;
      for (e = 0; e < b; e += p) m + n <= a && (h = x(c.slice(e, e + p), h),
        m += n);
      g += m;
      d = c.slice(m >>> 5);
      f = a % n;
  ...
  function K(c, a, b) {
    ...
    b = b || 0;
    f = b >>> 3;
    for (d = 0; d < c.length; d += 1) a = c.charCodeAt(d), h = d + f, e = h >>>
      2, g.length <= e && g.push(0), g[e] |= a << 8 * (3 - h % 4);
    return {
      value: g,
      binLen: 8 * c.length + b
    }
  ...
  function L(c, a, b) {
    ...
    b = b || 0;
    a = b >>> 3;
    if (-1 === c.search(/^[a-zA-Z0-9=+\/]+$/)) throw Error(
      "Invalid character in base-64 string");
    e = c.indexOf("=");
    c = c.replace(/\=/g, "");
    if (-1 !== e && e < c.length) throw Error(
      "Invalid '=' found in base-64 string");
    for (e = 0; e < c.length; e += 4) {
      m = c.substr(e, 4);
      for (h = q = 0; h < m.length; h += 1) f =
  ...
  function M(c, a, b) {
    ...
    b = b || 0;
    d = b >>> 3;
    for (a = 0; a < c.byteLength; a += 1) e = a +
      d, f = e >>> 2, g.length <= f && g.push(0), g[f] |= c[a] << 8 * (3 - e %
        4);
    return {
      value: g,
  ...
  function C(c, a) {
    var b = "",
      g = 4 * c.length,
      d, f;
    for (d = 0; d < g; d += 1) f = c[d >>> 2] >>> 8 * (3 - d % 4), b +=
      "0123456789abcdef".charAt(f >>> 4 & 15) + "0123456789abcdef".charAt(f &
        15);
  ...
  function D(c, a) {
    var b = "",
      ...
      d, f, e;
    for (d = 0; d < g; d += 3)
      for (e = d + 1 >>> 2, f = c.length <= e ? 0 : c[e], e = d + 2 >>> 2, e =
        c.length <= e ? 0 : c[e], e = (c[d >>> 2] >>> 8 * (3 - d % 4) & 255) <<
        16 | (f >>> 8 * (3 - (d + 1) % 4) & 255) << 8 | e >>> 8 * (3 - (d + 2) %
          4) & 255, f = 0; 4 >
        f; f += 1) 8 * d + 6 * f <= 32 * c.length ? b +=
        "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(
          e >>> 6 * (3 - f) & 63) : b += a.b64Pad;
    return b
  }
  ...
  function E(c) {
    var a = "",
      b = 4 * c.length,
      g, d;
    for (g = 0; g < b; g += 1) d = c[g >>> 2] >>> 8 * (3 - g % 4) & 255, a +=
  ...
  function B(c) {
    ...
    !0 === c.hasOwnProperty("b64Pad") && (a.b64Pad =
      c.b64Pad);
        ...
        b = function(b, c, f) {
          ...
          if ("UTF8" === a)
            for (m = 0; m < b.length; m += 1)
              for (f = b.charCodeAt(m),
                h = [], 128 > f ? h.push(f) : 2048 > f ? (h.push(192 | f >>>
                  6), h.push(128 | f & 63)) : 55296 > f || 57344 <= f ? h.push(
                  224 | f >>> 12, 128 | f >>> 6 & 63, 128 | f & 63) : (m +=
                  1, f = 65536 + ((f & 1023) << 10 | b.charCodeAt(m) & 1023),
                  h.push(240 | f >>> 18, 128 | f >>> 12 & 63, 128 | f >>> 6 &
                    63, 128 | f & 63)), n = 0; n < h.length; n += 1) {
                p = q + l;
  ...
  function V(c, a, b, g, d) {
    var f = (c & 65535) + (a & 65535) + (b & 65535) + (g & 65535) + (d &
      65535);
    return ((c >>> 16) + (a >>> 16) + (b >>> 16) + (g >>> 16) + (d >>> 16) +
  ...
  function v(c) {
    var a, b;
    a = [3238371032, 914150663, 812702999, 4144912697,
      4290775857, 1750603025, 1694076839, 3204075428
    ];
    b = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119,
    ...
    switch (c) {
      ...
      case "SHA-256":
        ...
        break;
      case "SHA-384":
        c = [new l, new l, new l, new l, new l, new l, new l, new l];
        break;
      case "SHA-512":
        c = [new l, new l, new l, new l, new l, new l, new l, new l];
        break;
  ...
  function A(c, a, b) {
    var g, d, f, e, h, l, m, n, k, t, p, u, r, v, y, z, A, B, C, D, E, G, w =
      [],
      F;
    if ("SHA-224" === b || "SHA-256" === b) t =
      64, u = 1, G = Number, r = T, v = U, y = V, z = R, A = S, B = P, C = Q,
      E = O, D = N, F = H;
    else throw Error("Unexpected error in SHA-2 implementation");
    b = a[0];
    g = a[1];
    ...
    l = a[6];
    m = a[7];
    for (p = 0; p < t; p += 1) 16 > p ? (k = p * u, n = c.length <= k ? 0 : c[
        k], k = c.length <= k + 1 ? 0 : c[k + 1], w[p] = new G(n, k)) : w[p] =
      v(A(w[p - 2]), w[p - 7], z(w[p - 15]), w[p - 16]), n = y(m, C(e), D(e,
        h, l), F[p], w[p]), k = r(B(b), E(b, g, d)), m = l, l = h, h = e, e =
      r(f, n), f = d, d = g, g = b, b = r(n, k);
    a[0] = r(b, a[0]);
    a[1] = r(g, a[1]);
    a[2] = r(d, a[2]);
    a[3] = r(f, a[3]);
